export const projects = [
  {
    title: "LinkFly",
    tech: "Next.js, PostgreSQL, Drizzle, BetterAuth, Vercel",
    link: "https://linkfly-three.vercel.app/",
    github: "https://github.com/Bunny099/linkfly",
    description: "AI tool to generate and optimize LinkedIn profiles and posts."
  },
  {
    title: "Officers",
    tech: "Next.js, TypeScript, PostgreSQL, Prisma, NextAuth",
    link: "https://officers-three.vercel.app/",
    description: "Role-based content and trust management platform for an organization."
  ...
  },
  {
    ...
    description: "Concurrency-safe hotel reservation backend with atomic booking and strict capacity enforcement."
  }
];
